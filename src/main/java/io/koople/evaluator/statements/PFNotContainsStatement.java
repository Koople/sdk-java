...
public class PFNotContainsStatement extends PFStatement<PFStringValue> {

    @JsonCreator
    public PFNotContainsStatement(@JsonProperty("attribute") @NotNull String attribute, @JsonProperty("values") @NotNull List<PFStringValue> values) {
    ...
    public static io.koople.evaluator.statements.PFNotContainsStatement of(String attribute, Object... values) {
        return new io.koople.evaluator.statements.PFNotContainsStatement(attribute, new ArrayList<PFStringValue>() {{
